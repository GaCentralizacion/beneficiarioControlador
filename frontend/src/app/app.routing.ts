...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            /**RUTAS BENEFICIARIO CONTROLADOR ADD BY LUIS ANTONIO GARCIA */

            {
                ...
                children: [
                    { path: 'beneficiario', loadChildren: () => import('app/modules/beneficiario/beneficiario.module').then(m => m.BeneficiarioModule) },
                ]
            },
